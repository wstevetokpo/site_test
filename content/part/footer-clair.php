<div id="modal" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog max-w-50">
        <div class="modal-content shadow rounded bg-color white">
                ...
                <div class="basic-intro">
                    <h2 class="title text-style-5">
                        ...
                        <span class="text-2 text-italic black">
                            pouvons-nous
                            <mark class="animated-underline primary">
                                vous aider
                            </mark>?
                        </span>
                    </h2>
        ...
        <div class="container">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <div class="footer-item">
                        <a href="<?= HOME_PATH ?>nos-services" class="button outline gray tertiary-hover">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="footer-item">
                        ...
                        <a class="footer-image black">
                            <img src="<?= HOME_PATH ?>assets/img/b-10.webp" alt="Image" class="image shadow">
                            <span class="title">
                                Voir portofolio
                            </span>
                        </a>
