...
<body class="shock-body">
    ...
    <main id="main" class="shock-main<?php if ( $__theme === 'dark' ) { echo ' bg-color black'; } ?>">
        <section id="home" class="shock-section has-overlay">
            <div class="banner" style="height: 100vh !important">
                <div class="content-wrapper text-center">
                    <div class="basic-intro mb-35">
                        <h2 class="title text-style-5">
                            <span class="text-2 text-italic white">
                                <mark class="animated-underline <?= $she ?>">
                                    <?= APP_NAME ?>
                                </mark>
                            </span>
                        </h2>
                        <h5 class="title text-style-2 text-offset">
                            <span class="text-1 filled white">
                                Nos valeurs
                            </span>
                            <span class="text-1 outline white" data-lax="inertia-top">
                                Nos valeurs
                            </span>
                        </h5>
                        <span class="text-2 text-style-4 fw-400 text-outline text-italic white">
                            sont <span class="typed-text"></span>
                        </span>
                    ...
                    <div class="divboss">
                        <a href="<?= HOME_PATH . '?theme=' . $prev ?>" class="cee">
                                <i class="fas fa-arrow-left"></i>
                        </a>
                        <a href="<?= HOME_PATH . '?theme=' . $next ?>" class="cee">
                ...
                <div class="image-wrapper" style="height: 100vh !important">
                    <video class="video vh-75 fit-cover" style="height: 100vh !important" playsinline="playsinline"
                        ...
                        <source src="<?= HOME_PATH ?>assets/vid/<?= $__theme ?>.mp4" type="video/mp4">
                    </video>
                </div>
            ...
            <section class="slide-item side-intro current-slide">
                ...
                <div class="slide-image-wrapper">
                    <div class="slide-image-inner">
                        <video autoplay src="<?= HOME_PATH ?>assets/vid/<?= $__theme ?>.mp4" class="slide-image"></video>
                    </div>
                </div>
                <div class="slide-action">
                    <div class="slide-action-inner">
                        ...
                        <a href="#modal" data-bs-toggle="modal" data-bs-target="#modal"
                            class="slide-action-link animated-text scheme-2 tertiary">
        ...
        <?php } else { ?>
        <section class="shock-section dynamic-slider scheme-1" data-autoplay="10000">
            <div id="slide-index" class="slide-index">
            ...
            <div class="slide-item side-intro current-slide">
                ...
                <div class="slide-image-wrapper">
                    <div class="slide-image-inner">
                        <img src="<?= HOME_PATH ?>assets/img/<?= $co ?>color.webp" alt="Image"
                            class="slide-image bg-color <?= $she ?>" />
                    </div>
                </div>
                <div class="slide-action">
                    <div class="slide-action-inner">
                        ...
                        <a href="#modal" class="slide-action-link animated-text scheme-1 <?= $she ?>"
            ...
            <div class="slide-item side-intro">
                ...
                <div class="slide-image-wrapper">
                    <div class="slide-image-inner">
                        <img src="<?= HOME_PATH ?>assets/img/<?= $co ?>color1.webp" alt="Image"
                            class="slide-image bg-color <?= $she ?>" />
                    </div>
                </div>
                <div class="slide-action">
            ...
            <div class="slide-item side-intro current-slide">
                ...
                <div class="slide-image-wrapper">
                    <div class="slide-image-inner">
                        <img src="<?= HOME_PATH ?>assets/img/<?= $co ?>color2.webp" alt="Image"
                            class="slide-image bg-color <?= $she ?>" />
                    </div>
                </div>
                <div class="slide-action">
                        ...
                        <div class="holder">
                            <div class="basic-intro mb-35">
                                <h2 class="title black">
                                    ...
                                    <span class="text-2 text-style-8 text-italic">l'<mark
                                            class="animated-underline <?= $she ?>">extraordinaire</mark>.
                                    </span>
                                </h2>
                                <div class="description gray">
                                    <p>
                                    ...
                                    <div class="radial-progress-bar">
                                        <div class="item">
                                            ...
                                            <div class="counter" data-value="100" data-symbol="%" data-duration="2500"
                                                ...
                                                data-bar-color="var(--<?= $she ?>-color)"
                                                data-empty-bar-color="var(--black-25-color)"
                                                data-text-bg-color="var(--<?= $she ?>-color)"
                                                data-text-color="var(--white-color)"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 col-md-4">
                                    <div class="radial-progress-bar">
                                        <div class="item">
                                            ...
                                            <div class="counter" data-value="87" data-symbol="%" data-duration="2500"
                                                data-bar-stroke="4" data-bar-stroke-empty="1"
                                                data-bar-color="var(--<?= $she ?>-color)"
                                                data-empty-bar-color="var(--black-25-color)"
                                                data-text-bg-color="var(--<?= $she ?>-color)"
                                ...
                                <div class="col-6 col-md-4">
                                    <div class="radial-progress-bar">
                                        <div class="item">
                                            ...
                                            <div class="counter" data-value="92" data-symbol="%" data-duration="2500"
                                                data-bar-stroke="4" data-bar-stroke-empty="1"
                                                data-bar-color="var(--<?= $she ?>-color)"
                                                data-empty-bar-color="var(--black-25-color)"
                                                data-text-bg-color="var(--<?= $she ?>-color)"
                        ...
                        <div class="gallery swiper slider has-navigation has-scrollbar scheme-1 primary"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="<?= HOME_PATH ?>assets/img/b-10.webp"
                                ...
                                <div class="swiper-slide">
                                    <a href="<?= HOME_PATH ?>assets/img/b-16.webp"
                                        class="item lightbox-link hover-zoom-rotate">
                                        <div class="image-wrapper">
